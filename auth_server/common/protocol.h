...
#define MSG_REGISTER_PEER    0x01
#define MSG_REGISTER_OK      0x02
#define MSG_REGISTER_FAIL    0x03
#define MSG_LOGIN            0x04
#define MSG_LOGIN_OK         0x05
#define MSG_LOGIN_FAIL       0x06
#define MSG_UPLOAD_TORRENT   0x07
#define MSG_LIST_TORRENTS    0x08
#define MSG_DOWNLOAD_TORRENT 0x09
#define MSG_TORRENT_DATA     0x0A
#define MSG_TORRENT_LIST     0x0B
#define MSG_ADMIN_LIST_USERS 0x0C
#define MSG_ADMIN_SET_ROLE   0x0D
#define MSG_ADMIN_FILE_STATS 0x0E
#define MSG_CHECK_UPLOAD     0x0F
...
static inline const char *msg_type_str(uint8_t type) {
    switch (type) {
        case MSG_REGISTER_PEER:    return "REGISTER_PEER";
        case MSG_REGISTER_OK:      return "REGISTER_OK";
        case MSG_REGISTER_FAIL:    return "REGISTER_FAIL";
